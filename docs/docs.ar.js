...
window.NYX_I18N = {
  ...
  _terms: {
    ...
    'How big is it': 'ما حجمه فعلاً؟',
    'Trim by module': 'التقليص بالوحدات',
    'Purge unused rules': 'إزالة القواعد غير المستخدمة',
    'Keep runtime classes': 'الإبقاء على أصناف التشغيل'
  },
  pages: {
    /* Getting Started */
    ...
    optimize: { title: 'تقليص الحجم', summary: 'حجم نيكس نحو 24 كيلوبايت للأنماط و22 كيلوبايت للسكربت بعد الضغط (gzip) — قريب من Bootstrap، فيمكن لمعظم المواقع استخدام الحزمة كاملة دون قلق. وإن أردت تقليصه فاستورد ما تحتاجه من الوحدات، أو أزِل القواعد غير المستخدمة. وبما أنّ كل صنف ثابت ودلالي يُقلَّم نيكس بنظافة — والقاعدة الوحيدة هي استثناء (safelist) الأصناف التي يضيفها nyx.js أثناء التشغيل.' },
