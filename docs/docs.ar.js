...
window.NYX_I18N = {
  ...
  pages: {
    ...
    zakat: { title: 'حاسبة الزكاة', summary: 'حاسبة حيّة بنسبة 2.5٪ (تُعدّل بـ data-rate). اكتب قيمة المال فيتحدّث المبلغ المستحقّ فوراً. أضف data-nisab للحدّ الأدنى فلا تجب الزكاة دونه — وتظهر حالة nyx-below-nisab.' },
    qibla: { title: 'مؤشّر القبلة', summary: 'بوصلة تشير إبرتها نحو القبلة. أعطها data-coords="lat,lng" فيحسب التشغيل اتجاه القبلة إلى الكعبة (أو اضبط data-nyx-qibla بالدرجات). ومتاحة أيضاً كـ Nyx.qiblaBearing.' },
    delivery: { title: 'تتبّع الشحن', summary: 'مخطّط زمني عموديّ لتتبّع الطلب — علّم الخطوات بـ done (مكتملة) وcurrent (جارية).' },
    'id-input': { title: 'الهوية / الإقامة', summary: 'حقل مُقَنَّع لرقم الهوية السعودية المكوّن من 10 أرقام. يبقيه التشغيل أرقاماً فقط ومن اليسار، ويتحقّق من رقم التحقّق (Luhn) لا الصيغة فقط، ويسمّي صاحبه من أوّل رقم — 1 مواطن، 2 مقيم. يعمل كحقل رقمي عادي بدون JS.' },
    'name-ar': { title: 'الاسم الرباعي', summary: 'تخطيط الاسم العربي الرباعي المستخدم في النماذج الحكومية والبنكية — الأول والأب والجد والعائلة. أضف triple لإسقاط حقل الجد. يتحوّل إلى عمودين على الجوال.' },
    'national-address': { title: 'العنوان الوطني', summary: 'نموذج العنوان الوطني السعودي — رقم المبنى والرقم الإضافي والشارع والحي والمدينة والرمز البريدي — مع عرض مميّز للعنوان المختصر. full يمدّ الحقل لكامل الصف.' },
    'region-select': { title: 'اختيار المنطقة', summary: 'قائمة منسدلة أصلية مزيّنة بدبّوس موقع لاختيار منطقة سعودية أو دولة خليجية. الدبّوس في البداية والسهم في النهاية، وينعكسان تلقائياً في RTL.' },
    'hijri-convert': { title: 'محوّل التاريخ الهجري', summary: 'تحويل بين التاريخ الهجري والميلادي في الاتجاهين. يعتمد على تقويم أم القرى الرسمي عبر Intl مع بديل حسابي عند عدم توفّره — عدّل أيّ جهة فتتحدّث الأخرى فوراً. يوفّر أيضاً Nyx.toHijri / fromHijri / formatHijri، وخاصية واحدة [data-nyx-hijri-today] لطباعة تاريخ اليوم الهجري في أي مكان.' },
    /* Commerce */
    ...
    bnpl: { title: 'التقسيط (ادفع لاحقاً)', summary: 'عناصر «اشترِ الآن وادفع لاحقاً» بأسلوب تابي / تمارا — شارة مختصرة وجدول أقساط كامل بحالات paid وcurrent. اسم المزوّد لك، وأعد تلوينه بـ --nyx-accent.' },
    invoice: { title: 'فاتورة ضريبية (ZATCA)', summary: 'ترويسة فاتورة ضريبية مبسّطة بتنسيق هيئة الزكاة — البائع، والرقم الضريبي، وخانة لرمز QR للفاتورة، وشبكة بيانات، وإجماليات بسطر منفصل لضريبة 15٪. ضع رمز QR (img/svg) داخل nyx-invoice-qr.' },
    /* Media & Nav */
